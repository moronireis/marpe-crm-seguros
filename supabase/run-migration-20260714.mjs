...
const STATEMENTS = [
  {
    name: 'ADD photo_synced_at TO marpe_contacts',
    sql: `ALTER TABLE public.marpe_contacts ADD COLUMN IF NOT EXISTS photo_synced_at timestamptz;`,
  },
  {
    name: 'VERIFY photo_synced_at column exists',
    sql: `SELECT column_name FROM information_schema.columns WHERE table_name = 'marpe_contacts' AND column_name = 'photo_synced_at';`,
    verify: true,
  },
];
...
async function run() {
  console.log('=== Marpe CRM Migration 2026-07-14: Add photo_synced_at ===\n');
