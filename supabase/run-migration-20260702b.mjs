...
const STATEMENTS = [
  {
    name: 'ADD tipo_negocio TO marpe_deals',
    sql: `ALTER TABLE public.marpe_deals ADD COLUMN IF NOT EXISTS tipo_negocio text;`,
  },
  {
    name: 'VERIFY tipo_negocio column exists',
    sql: `SELECT column_name FROM information_schema.columns WHERE table_name = 'marpe_deals' AND column_name = 'tipo_negocio';`,
    verify: true,
  },
];
...
async function run() {
  console.log('=== Marpe CRM Migration 2026-07-02b: Add tipo_negocio ===\n');
