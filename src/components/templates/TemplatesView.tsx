...
const VARIABLES_NEGOCIO = [
  ...
  { token: '{{premio}}', label: 'Prêmio final (líquido + IOF)' },
  { token: '{{premio_liquido}}', label: 'Prêmio líquido' },
  { token: '{{iof}}', label: 'IOF' },
  { token: '{{forma_pagamento}}', label: 'Forma de pagamento' },
  { token: '{{parcelas}}', label: 'Parcelamento' },
